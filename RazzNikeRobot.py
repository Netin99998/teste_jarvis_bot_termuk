...
def boavinda(message1):
    ...
    if ide in liste:
        ...
        bot.reply_to(message1, '<b>' '🔥 VOCÊ TEM ACESSO PORRA! 🔥' '</b>', parse_mode='HTML')
        ...
        bot.send_message(ide, '<b>' '✅ Compre o seu acesso com meu Dono @iara_limaz' '</b>', parse_mode='HTML')
            ...
            if id1 in ltnome:
                try:
                	...
                	bot.reply_to(nome, '<b>' 'TÁ ERRADO VEI !' '</b>', parse_mode='HTML')
                		...
                		bot.reply_to(nome, '<b>' '✅ Compre acesso com meu Dono @iara_limaz✅' '</b>', parse_mode='HTML')
...
def beroi(men):
            ...
            if int(idee) in permitidos:
                        ...
                        try:
                            ...
                            try:
                                ...
                                bot.reply_to(men, '<b>' '✅ CONSULTA DE TEL CONCLUIDA ✅' '</b>' + '\n\n' + '<code>' +
                                             dados + '</code>' + '\n<b>CPF: </b>' '<code>' + cpf + '</code>' + '\n\n<b>• DONO: @iara_limaz\n• GRUPO: @iara_consultas• CANAL: @iara_referencias</b>',
                                             parse_mode='HTML')
                            except:
                ...
                bot.reply_to(men, '<b>' '✅ Compre acesso com meu Dono @iara_limaz ✅' '</b>', parse_mode='HTML')
...
def byti(men):
            ...
            if int(chtid) in permitidos:
                ...
                bot.reply_to(men, '<b>✅ Compre acesso com meu Dono @iara_limaz ✅</b>',
                             parse_mode='HTML')
...
def sjjsn(nome):
            ...
            if id1 in ltnome:
                ...
                bot.reply_to(nome, '<b>✅ Compre acesso com meu Dono @iara_limaz/b>',
                             parse_mode='HTML')
...
def bunda(message1):
            ...
            if ideee in lib:
                ...
                bot.reply_to(message1,
                             '<b>' + '✅ Compre acesso com meu dono @iara_limaz✅' + '</b>',
                             parse_mode='HTML')
